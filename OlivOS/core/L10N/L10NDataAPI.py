...
dictL10NSTR = {
    'en-US': {
        ...
        'onebotV11HostServerAPI_0001': 'OlivOS onebotV11 host server [{0}] is running on [{1}]',
        'onebotV11HostServerAPI_0002': 'OlivOS onebotV11 host server [{0}] websocket link will retry in {1}s',
        'onebotV11HostServerAPI_0003': 'OlivOS onebotV11 host server [{0}] websocket link error: \n{1}',
        'onebotV11HostServerAPI_0004': 'OlivOS onebotV11 host server [{0}] websocket link close',
        'onebotV11HostServerAPI_0005': 'OlivOS onebotV11 host server [{0}] websocket link start',
        'onebotV11HostServerAPI_0006': 'OlivOS onebotV11 host server [{0}] websocket link lost',
        'onebotV11HostServerAPI_0007': 'OlivOS onebotV11 host server [{0}] websocket link port [{1}] is in use',
        'onebotV11HostServerAPI_0008': 'OlivOS onebotV11 host server [{0}] unauthorized token: [{1}]',
        'onebotV11LinkServerAPI_0001': 'OlivOS onebotV11 link server [{0}] websocket link will retry in {1}s',
        'onebotV11LinkServerAPI_0002': 'OlivOS onebotV11 link server [{0}] websocket link error: \n{1}',
        'onebotV11LinkServerAPI_0003': 'OlivOS onebotV11 link server [{0}] websocket link close',
        'onebotV11LinkServerAPI_0004': 'OlivOS onebotV11 link server [{0}] websocket link start',
        'onebotV11LinkServerAPI_0005': 'OlivOS onebotV11 link server [{0}] websocket link lost',
        ...
        'OPQBotLinkServerAPI_0001': 'OlivOS OPQBot link server [{0}] is running on [{1}]',
        'OPQBotLinkServerAPI_0002': 'OlivOS OPQBot link server [{0}] websocket link will retry in {1}s',
        'OPQBotLinkServerAPI_0003': 'OlivOS OPQBot link server [{0}] websocket link error',
        'OPQBotLinkServerAPI_0004': 'OlivOS OPQBot link server [{0}] websocket link close',
        'OPQBotLinkServerAPI_0005': 'OlivOS OPQBot link server [{0}] websocket link start',
        'OPQBotLinkServerAPI_0006': 'OlivOS OPQBot link server [{0}] websocket link lost',
        ...
        'libOPQBotEXEModelAPI_0001': 'OlivOS libOPQBotEXEModel server [{0}] can`t found target lib',
        'libOPQBotEXEModelAPI_0002': 'OlivOS libOPQBotEXEModel server [{0}] will run under visiable mode',
        'libOPQBotEXEModelAPI_0003': 'OlivOS libOPQBotEXEModel server [{0}] will retry in 10s...',
        'libOPQBotEXEModelAPI_0004': 'OlivOS libOPQBotEXEModel failed: {0}\n{1}',
    ...
    'zh-CN': {
        ...
        'onebotV11HostServerAPI_0001': 'OlivOS onebotV11 主机服务组件 [{0}] 正在运作，采用WS服务器 [{1}]',
        'onebotV11HostServerAPI_0002': 'OlivOS onebotV11 主机服务组件 [{0}] WebSocket 连接 将在{1}秒内重试',
        'onebotV11HostServerAPI_0003': 'OlivOS onebotV11 主机服务组件 [{0}] WebSocket 连接 发生错误: \n{1}',
        'onebotV11HostServerAPI_0004': 'OlivOS onebotV11 主机服务组件 [{0}] WebSocket 连接 已经关闭',
        'onebotV11HostServerAPI_0005': 'OlivOS onebotV11 主机服务组件 [{0}] WebSocket 连接 已经启动',
        'onebotV11HostServerAPI_0006': 'OlivOS onebotV11 主机服务组件 [{0}] WebSocket 连接 已经丢失',
        'onebotV11HostServerAPI_0007': 'OlivOS onebotV11 主机服务组件 [{0}] WebSocket 连接 端口 [{1}] 已被占用',
        'onebotV11HostServerAPI_0008': 'OlivOS onebotV11 主机服务组件 [{0}] 收到未授权访问令牌: [{1}]',
        'onebotV11LinkServerAPI_0001': 'OlivOS onebotV11 连接服务组件 [{0}] WebSocket 连接 将在{1}秒内重试',
        'onebotV11LinkServerAPI_0002': 'OlivOS onebotV11 连接服务组件 [{0}] WebSocket 连接 发生错误: \n{1}',
        'onebotV11LinkServerAPI_0003': 'OlivOS onebotV11 连接服务组件 [{0}] WebSocket 连接 已经关闭',
        'onebotV11LinkServerAPI_0004': 'OlivOS onebotV11 连接服务组件 [{0}] WebSocket 连接 已经启动',
        'onebotV11LinkServerAPI_0005': 'OlivOS onebotV11 连接服务组件 [{0}] WebSocket 连接 已经丢失',
        ...
        'OPQBotLinkServerAPI_0001': 'OlivOS OPQBot 连接服务组件 [{0}] 正在运作, 采用WS服务器 [{1}]',
        'OPQBotLinkServerAPI_0002': 'OlivOS OPQBot 连接服务组件 [{0}] WebSocket 连接 将在{1}秒内重试',
        'OPQBotLinkServerAPI_0003': 'OlivOS OPQBot 连接服务组件 [{0}] WebSocket 连接 发生错误',
        'OPQBotLinkServerAPI_0004': 'OlivOS OPQBot 连接服务组件 [{0}] WebSocket 连接 已经关闭',
        'OPQBotLinkServerAPI_0005': 'OlivOS OPQBot 连接服务组件 [{0}] WebSocket 连接 已经启动',
        'OPQBotLinkServerAPI_0006': 'OlivOS OPQBot 连接服务组件 [{0}] WebSocket 连接 已经丢失',
        ...
        'libOPQBotEXEModelAPI_0001': 'OlivOS OPQBot进程托管服务组件 [{0}] 无法找到库文件',
        'libOPQBotEXEModelAPI_0002': 'OlivOS OPQBot进程托管服务组件 [{0}] 将在前台模式下运行',
        'libOPQBotEXEModelAPI_0003': 'OlivOS OPQBot进程托管服务组件 [{0}] 将在10秒后重试...',
        'libOPQBotEXEModelAPI_0004': 'OlivOS OPQBot进程托管服务组件 错误: {0}\n{1}',
